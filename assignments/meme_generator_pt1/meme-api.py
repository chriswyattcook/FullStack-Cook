...
def meme():
    ...
    params:
        ...
        - userid or email of owner ('anonymous' otherwise)
    """
    meme_dict = request.args.to_dict()
    ...
    new_document = {
        ...
        "bot_text" : meme_dict['bot_text'],
        "style_info" : {
            "text-color" : meme_dict['text-color'],
            "text-size" : meme_dict['text-size'],
            "font" : meme_dict['font']
        },
        "file_id" : 5,
        "owner_id" : 2
    ...
    client['memes_db']['memes'].insert(new_document)
